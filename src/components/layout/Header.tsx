...
const services = [
  ...
  { name: 'Prototypage Rapide', href: '/services/prototypage', description: 'Du concept au prototype' },
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <span className="text-2xl font-bold text-gradient">Inphenix</span>
              <span className="text-2xl font-light text-secondary-600">System</span>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <div className="relative">
              <button
                ...
                className="px-4 py-2 text-secondary-700 hover:text-primary-600 font-medium flex items-center gap-1 transition-colors"
              >
                Services
            ...
            <Link
              href="/realisations"
              className={`px-4 py-2 font-medium transition-colors ${pathname === '/realisations' ? 'text-primary-600' : 'text-secondary-700 hover:text-primary-600'}`}
            >
              Réalisations
            </Link>
            ...
            <Link
              ...
              className={`px-4 py-2 font-medium transition-colors ${pathname === '/qui-sommes-nous' ? 'text-primary-600' : 'text-secondary-700 hover:text-primary-600'}`}
            >
              Qui sommes-nous
            </Link>
